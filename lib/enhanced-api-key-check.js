...
No API key found in:
- Environment variable: OPTIMIZER_API_KEY
- Config file: ~/.mcp_optimizer/config.json
- .env file in project directory

To get started:
1. Sign up for a FREE key (5 daily optimizations) at:
   https://promptoptimizer.xyz/local-license

2. Set your API key:
   export OPTIMIZER_API_KEY="your-key-here"

Or upgrade to PRO for unlimited optimizations!`);
    }
...
- sk-local-basic-1234567890abcdef1234567890abcdef (Free - 5 daily)
- sk-local-pro-1234567890abcdef1234567890abcdef (Pro - Unlimited)

Get a valid key at: https://promptoptimizer.xyz/local-license`);
    }
